...
Switch the persona to Founder and open `/intelligence`. 209 of 500 customers consented; only they are counted anywhere on this page. At a minimum cohort of 10, six states show a leading segment and 31 are hatched as insufficient data.
...
Switch to Partner Brand and open `/brand`. Pick **insulin**, **25-34**, a $20,000 budget, a 90-day window.
...
Switch to Founder and open `/model`. Choose **Membership first**. Drag the retest rate from 30% to 60%. The implied valuation moves from about $279M to about $343M and the tiles count to their new values.
