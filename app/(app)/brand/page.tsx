...
export default async function BrandPage() {
  ...
  try {
    ...
    if (all && !all.suppressed && all.value !== null) fallbackRate = all.value;
  } catch (err) {
  ...
  return (
    <>
      ...
      <BrandSimulator baselines={baselines} fallbackRate={fallbackRate} minCohort={minCohort} />
    </>
  );
}
